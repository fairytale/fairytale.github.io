...
let contents = [
  ...
  p "　ある日希海が大学から帰ってくる(けっきょく希海は言って復学したのだ)と、リコが希海に抱きついてきた！";
  ...
  p "「なになになになに、今日はだれの誕生日？」";

  p "「ちがいますよぉ、素直な気持ちなんです」";

  p "　これでも希海は定精神医療従事者の免許持っている。二種だけど。そんな希海がまず最初に考えたのはリコのFIANCが未知のニューロワームに感染してしまったということだ。";

  p "　でも単純にほんとうにリコのサプライズかもしれない。";

  p "　希海はたずねた。";

  p "「もしこれがわたしを良い気持ちにさせるための冗談なら正直に答えて？　リコは計画的にそう言っているの？」";

  p "　リコは頬を膨らませて抗議した。";

  p "「計画？　そんなものありませんよ。ただずっと想いを打ち明けたかっただけのことです」";
  ...
  p "「次の休みの日、って言ってもわたし毎日朝9時に大学行かなくちゃいけないからいつになるかわかんないけど、病院に行ってしっかり検査して";
  p "もらいましょう」";
  ...
  p "「わたし、ずっと2人きりになりたかったんですよ……希海さんと……たった2人きりで……ずっと」";
  ...
  p "「そんな！　太陽なんていったいどうやって破壊すれば……！　わたしの力では不可能だ！　超新星爆発級のエネルギーがないと……！」";
  ...
  p "「リコ、あなたはいま病気なのよ。自分では気づいていないかもしれないけど。気持ちは偽りのものなの」";
  ...
  p "「\"このままでもいい\"、むしろ、\"このままのほうがいい\"と思っているからです。わたしは希海さんと将来ずっと仲良くできるなら、たとえ病気でも……悪くないと思っています」";

  p "　リコは言った。";

  p "「核の大きさは気持ちの強さなんです。この状態を継続したいという感情の表れなんです。本を読んで勉強しました。そして、この世界の核がこんなに大きいのは、あれがわたしひとりの気持ちではないからです。あれは……わたしと希海さん、ふたりの気持ちをかけ算したものです」";
  ...
  p "「そんなわけない！」希海は否定した。「わたしは、リコが病気のままでいいなんて思ってない！」";

  p "「ほんとうですか？」リコはたずねた。「心の底からそう思っているなら、太陽は潰れるはずです……わたしひとりの気持ちなら、あんなに大きくできません」";
  ...
  p "「ごめんね……寂しかったよね。リコの気持ちがわかったよ。今度2人きりで海へ行こう」";
