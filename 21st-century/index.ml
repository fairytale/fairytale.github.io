...
let contents =
  ...
  [
    ...
    h3 <<2011年>>;
    (*p <<
       　2011年はわたしにとって最悪の年だった。当時わたしは小学5年生で、
       宮城県の父方の実家で暮らしていた。ところが3月11日、のちに言う
       $earthquake#link$が起きて、父方の実家も小学校も流され、お父さんも
       お母さんも、小学校で仲のよかった友達も、みんな死んでしまった。
       >>;
    p <<
       　津波が町を飲み込む姿はそのあと何度も夢で見たし、そのたびに
       全身にびっしょり嫌な汗をかいて、夜中に目が覚めるのだ。
       >>;
    p <<
       　わたしは茨城県の母方の実家に引き取られ、お婆ちゃんの
       手厚い保護のもと育てられた。
       >>;*)
    ...
    (*p <<
       ...
       わたしも津波に飲まれたら死んじゃうと思って、一目散に裏山へ
       向かって走りだした。>>;
    p <<
       　さいんちゃんは腰を抜かしてその場にへたり込み、
       呆然と津波を見ていた。わたしはそれを見て大声で言った。>>;
    p <<「なにしてるの、さいんちゃん、いま逃げなくちゃ死んじゃうかも
       しれないんだよ！」>>;
    p <<　でも、さいんちゃんは動かなかった。
       答えてくれることすらなかった。>>;
    p <<　わたしは一度戻ってさいんちゃんの手をとり、連れて行こうと
       引っ張った。でも彼女は動かなかった。彼女は震える声で言った。>>;
    p <<「コーリちゃんだけで逃げて。腰が抜けてうまく立てないの。
       だいじょうぶ、わたしは大人におんぶしてもらうから」>>;
    p <<　津波がすぐそこまで迫ってきた。さいんちゃんを置いていきたくない。
       でも、わたしの力でさいんちゃんをおんぶできるとは思えない。
    ...
    p <<「ありがとう」>>;
    (*p <<　だけどその直後、橋の上まで激流が飛び込んできた。さいんちゃんは
       手すりと橋のあいだの穴から流されてしまった。
       わたしも流されたけど、橋の手すりに捕まってなんとか流されずに済んだ。>>;
    p <<　だけど流れが強過ぎて手すりに捕まっているのも限界だった。
       と、そのとき、わたしの前に家の屋根が流れてきて、わたしはなんとか
       這い上がって屋根の上に逃れた。>>;
    p <<　屋根の>>;*)
    ...
    p <<
       ...
       ただひとりが怖くて、仲間が欲しかった。だから彼女に話しかけてみる
    ...
    p <<
       「ここで食べていい？」>>;
    p <<
       　女の子はぎょっとした。当然だ。わたしと彼女は言葉を話したこと
    ...
    p <<「って言っても、食中毒だからって死ぬわけじゃないし。
       でもそれは捨てたほうがいいかもね」>>;
    (*p <<　それからからむちゃんはウーロン茶にはいっさい口をつけず、
       ごみ箱を探して捨てた。>>;
    p <<　それから、わたしたちは国際展示場駅へ向かった。>>;
    p <<　でも、その途中で、からむちゃんが頭痛を訴えた。
       頭がずきずきするらしい。そんな状態であの混んだ電車に乗せる
       わけにはいかない。わたしは言った。>>;
    p <<「すこし休んでく？」>>;
    p <<「うん、悪いけど、そうする……」>>;
    p <<　冬は寒い。わたしたちは国際展示場駅の前のベンチで休んでいた。
       からむちゃんの症状は悪化していた。>>;*)
    p <<
       　そのときいきなり、からむちゃんは
    ...
    (*p <<「ぼくは料理をつくるのは好きだけど他人のことは信用してないんだ。
       ぼく以外の人間はみんなバカだ。勉強ができるだけのバカだ。
       だから料理もできない」>>;
    p <<　なんだこの子。ああ、そういえば、高校1年生だっけ？　わたしもそういう
       考え方してた頃だったなあ、と懐かしくなる。>>;
    p <<　わたしはかれに良い印象を抱かなかったけど、わたしのほうが
       大人だから、ここで怒るのは大人げないだろうと思ったし、悔しいけど
       料理ができるのは事実だから、おだやかに言った。>>;
    p <<「あなたがいちばんだってのは認める。すくなくとも料理においては
       それは事実だし。でも、わたし、文化祭で恥をかきたくないのよ。
       教えてほしいのよ」>>;
    p <<「教えてほしい？　そういう態度だからダメなんだ。新田さん、
       自分で本を読んだり、だれかを見て技術を盗もうとしたり、
       毎晩必死にいろいろ試したり、どれかひとつでもした？」>>;
    p <<　わたしは眉をぴくぴくさせた。どうして初対面でそこまで
       言われなければならないのか。でも、わたしは下手にでるしかなかった。
       そうめんとかけうどんしか作れないのでは、男子にモテるはずがない。
       わたしは覚えるしかないのだ。>>;
    p <<　かれは続けた。>>;
    p <<「教えはしないよ。明日ぼくはたまたまオムライスをつくるんだ。
       明日ぼくはたまたまオムライスが食べたい気分になるだろうからね。
       それを特別に近くで見せてあげるよ」>>;
    p <<　こうしてわたしは冬野くんがオムライスをつくるところを
       近くで見せてもらった。>>;
    p <<　冬野くんは口は悪かったけど、教え方は>>;*)

    (*h3 <<2012年>>;
    p <<　2012年の4月にわたしは茨城の中学校に上がった。>>;
    p <<
       　わたしは、この頃から、わたしはこの世でいちばん不幸な存在なのだと
       思うようになった。
       だって大震災で友達や親族を失った経験のある人は周りにいなかった。
       >>;
    p <<
       　クラスの半分くらいの友達がスマホを持っていて、わたしはどうしても
       スマホが欲しくなった。でも、もう中学生なんだし、大人にならなくちゃと
       思って、遠慮して言い出せなかった。
       >>;
    h3 <<2015年>>;
    p <<　2015年の4月には茨城の高校に入学した。>>;
    p <<
       　なにか部活に入りたいわけじゃなかったけど、
       なにも部活に入らないのも恥ずかしかったので、茶道部に入った。>>;
    p <<
       　高校に入って半年もすると、友達のほとんどがだれかと
       デートをしたりキスをしたりその先をしたり、恋愛経験を積む
       ようになっていた。わたしも、友達に恋バナを聞かされるようになった。
    ...
    p <<
       ...
       料理がうまいとモテると思ったからだ。>>;
    h3 <<2016年>>;
    p <<　2016年2月、誕生日に、わたしはお婆ちゃんに
       $firefox_os#link$搭載のスマホを買ってもらった。
       これがわたしのインターネットとの初めての出会いだった。>>;
    p <<
       　スマホを買ってから1年間くらい、わたしはインターネットより
       TVを見ている時間のほうが多かった。>>;
    p <<
       　この頃、WindowsやMacといった
       メジャーなOSではなく、$ubuntu#link$という聞いたこともないOSを搭載した
       パソコンのCMを見ることが多かった。聞くところによるとUbuntuを
       搭載したパソコンはすごく安いらしい。安物は粗悪品で、値段が高い者は
       高品質だという偏見がわたしにはあったので、わたしは自分で買うなら
       Macがいいなと思っていた。>>;
    h3 <<2017年>>;
    p <<　2017年2月、情報処理の授業で必要だったので、
       Ubuntu搭載のラップトップを買ってもらった。
    ...
    p <<　入学式の朝、わたしは部屋の棚にかけてあるさいんちゃんと
       からむちゃんの写真の前で、正座をして、目をつむって手を合わせて
       小さな声で言った。>>;
    p <<「さいんちゃん、からむちゃん、わたしもついに大学生になったよ。
    ...
    p <<　事件の犯人は3人いる。ひとりは晴さん、そしてもうひとりは首謀者として
       ...
       自殺した。ほかの11人の人を巻き添えにして、無差別殺人を装って。>>;
    ...
    p <<　もしかれがプロポーズしてくれたら、どんなに楽だっただろう。
       選択も、考えることも人任せにできたら、わたしはどれだけ
       悩まずに済んだだろう。>>;
    p <<　でも、いまは違う。なつばなくんはそういうことを自分からしだす
       タイプではない。>>;
    p <<　わたしは、自分で考えて、自分で行動しなくちゃいけないのだ。>>;
    (*p <<　わたしにとって？　わたし、いまそう考えたのか。>>;
    p <<　わたしはため息をついた。>>;
    p <<　やっぱり、わたしはからむちゃんのためにやっているわけじゃなかった。
       すべては、わたしがすっきりしたいからやっていることなのだ。>>;*)
    (*p <<　電車のなかで、わたしはいろいろと考えていた。わたしはどうすべき
       なのだろう。録音した内容を届けるべきなのだろうか。それとも同情して
       見逃すべきなのだろうか。>>;
    p <<　もしわたしがこれを提出すれば、晴さんはたぶん捕まる。
       これを証拠に再捜査がされて、もしかしたら保険金詐欺が発覚し、
       保険金は取り上げられるかも。>>;
    p <<　それは嫌だ。>>;
    p <<　わたしは同情していた。かれらに。>>;
    p <<　わたしがかれらを有罪にしたら、当然、かれらの人生は
       おしゃかになる。もちろん、からむちゃんの人生を、それだけでなく、
       無関係な10人を巻き添えにした事件だ。かれらは悪人だ。でも、
       だからといって、死んだ11人のために、さらに生きている2人の命を
       奪うべきだと、胸を張って言えるのか？>>;
    p <<　晴さんは悪い人には思えなかった。かれにはかれの生活があった。
       首謀者にも。そのためにこんな事件を犯すことは悪いことだ。
       でも、復讐することが良いこととは、わたしには思えなかった。>>;
    p <<　わたしは帰宅して、からむちゃんの写真の前にボイスレコーダーを
       置いて、正座し、話し始めた。>>;
    p <<「からむちゃん、すべてを話すよ。あなたが殺された日のことを。
       あなたには知る権利がある。自分がどうして殺されたのかを。
       あなたは納得できないと思う。かれらの私利私欲のために殺された
       っていうんだから、復讐したいと思う。でも、わたしは晴さんの話を
       聞いて、かれが心底の悪人にはとうてい思えなかった。かれは更生するって
       いうか、すでにまじめに生きている人みたいだし、5年前のあの日のことに
       ついては、水に流すとは言わないまでも、忘れちゃったほうがいいんじゃない
       かって、わたしは思う」>>;
    p <<　わたしは続けて話したので深呼吸した。それから、
       晴さんのことや、名前は知らないけど首謀者のことなんかを話した。>>;
    p <<　こうしてわたしはからむちゃんに言い訳してるけど、
       ほんとうに考えているのは、わたしのことだ。いろいろ言い繕っているけど、
       ただ単に、わたしが復讐したいという気持ちが、5年間でかなり薄れてしまった
       ということと、わたしがかれに小さな愛情を感じて、かれを殺すのは
       忍びないと思ったということと、あと、自分の手を汚したくないっていうだけの
       ことだ。>>;
    p <<　自分のことばかり考えて、ほんと、嫌んなっちゃう。>>;*)
   (* p <<　わたしはボイスレコーダーはからむちゃんに捧げて、春休み明けに向けて
       勉強をすることにした。冬休みと春休みはほとんどサボっていたので
       いくらでもすることがある。そろそろインターンとか考え始めないと
       いけないし。>>;
    p <<　数学ガール、読んでみようかな。数学はいまでも苦手なんだけど、
       中学のときのからむちゃんよりはできると信じたい。
       ひょっとしたらいまならわかるかも。>>;
    p <<　わたしは勉強はひとまず先送りにして、とりあえず図書館に行くことに
       した。>>;*)
    ...
    dl
      ...
      ; dt <<コミケシアン化合物無差別殺人事件>>
      ; dd <<2014年12月のC87で起きた事件。からむ含む計12人が死亡した。>>
      ];
